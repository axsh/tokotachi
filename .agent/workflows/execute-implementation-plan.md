...
3.  **コーディング**:
    ...
    *   **重要**: `.agent/rules/coding-rules.md` に記載されたスタイルや設計原則を厳守してください。
4.  **こまめな Git コミット**:
...
*   モジュール構成の変更: `prompts/memory/current.md` の Repository Structure / Module Responsibilities を更新
*   設計判断の追加: `prompts/memory/decisions.md` に記録
*   新しい制約の発見: `prompts/memory/invariants.md` に追加
*   分類不明な場合: `prompts/memory/inbox.md` に追記
