...
kind: capability
id: pre-sync-knowledge-compile
title: Pre-Sync Knowledge Compile
description: >-
  Before creating a Pull Request or pulling from a remote/local branch,
  ensure all pending intake events have been systematized and compiled
  into agent-readable skills via the systematize-far-knowledge workflow.
paths:
  - "prompts/memory/**"
  - ".agents/skills/**"
references:
  - "prompts/manifest/code_content/procedures/systematize-far-knowledge.md"
  - "prompts/manifest/code_content/capabilities/pre-push-knowledge-check.md"
scripts:
